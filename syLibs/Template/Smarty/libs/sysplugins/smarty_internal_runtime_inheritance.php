...
class Smarty_Internal_Runtime_Inheritance
{
    ...
    public function callParent(Smarty_Internal_Template $tpl, Smarty_Internal_Block $block, $name = null)
    {
        if (isset($name)) {
            ...
            throw new Smarty_Exception("inheritance: illegal {\$smarty.block.parent} or {block append/prepend} used in parent template '{$tpl->inheritance->sources[$block->tplIndex]->filepath}' block '{$block->name}'");
        }
    }
