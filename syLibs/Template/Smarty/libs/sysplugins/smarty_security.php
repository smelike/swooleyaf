...
class Smarty_Security
{
     ...
     * @throws Smarty_Compiler_Exception if php function is not trusted
     */
     ...
     * @throws Smarty_Compiler_Exception if static class is not trusted
     */
     ...
     * @throws Smarty_Compiler_Exception if static class method is not trusted
     */
     ...
     * @throws Smarty_Compiler_Exception if modifier is not trusted
     */
    ...
    private function _checkDir($filepath, $dirs)
    {
        ...
        // give up
        throw new Smarty_Exception("directory '{$filepath}' not allowed by security setting");
    }
