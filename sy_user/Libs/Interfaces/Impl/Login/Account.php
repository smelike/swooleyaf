...
class Account extends LoginBase implements LoginService {
    public function __construct() {
        parent::__construct();
        $this->loginType = Project::LOGIN_TYPE_ACCOUNT;
     ...
     * @SyFilter-{"field": "user_account","explain": "账号","type": "string","rules": {"required": 1,"min": 1}}
