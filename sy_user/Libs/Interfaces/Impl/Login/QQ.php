...
class QQ extends LoginBase implements LoginService {
    public function __construct() {
        parent::__construct();
        $this->loginType = Project::LOGIN_TYPE_QQ;
     ...
     * @SyFilter-{"field": "user_qq","explain": "QQ号码","type": "string","rules": {"required": 1,"regex": "/^[0-9]\d{5,11}$/"}}
