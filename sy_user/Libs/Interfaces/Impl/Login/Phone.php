...
class Phone extends LoginBase implements LoginService {
    public function __construct() {
        parent::__construct();
        $this->loginType = Project::LOGIN_TYPE_PHONE;
     ...
     * @SyFilter-{"field": "user_phone","explain": "手机号码","type": "string","rules": {"required": 1,"phone": 1}}
